...
def sort(dir):
	...
	# print('os.path.getmtime',os.path.getmtime)
	# file_list.sort(key=os.path.getmtime)
	# print("\n".join(file_list))
	return file_list

def convert(source_cfg,source_weights,output_path):
	cfg_parser = DarkNetParser(source_cfg,source_weights)
	layers_fun = {
	...
	cfg_parser.create_and_save(parser().weights_only, output_path)
	cfg_parser.close()
...
'''
python "../Python Service/WeightCfg2H5/yolov3_darknet_to_keras.py" -weights_path model_13100.weights
python "../Python Service/WeightCfg2H5/yolov3_darknet_to_keras.py" -weights_path model_13100.weights
